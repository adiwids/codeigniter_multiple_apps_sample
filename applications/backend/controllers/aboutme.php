	...
	public function index()
	{
            ...
            else
            {
                if($this->session->userdata('logged'))
                {
                    ...
                    $this->load->view("aboutpage", $this->property);
                }
            }
	}
	...
	public function savedata()
	{
            ...
            if(isset($_FILES))
            {
                if(!empty($_FILES['_photo']['name']))
                {
                    ...
                    if(!file_exists("./assets/uploads/about/".$name))
                    {
                        if($this->upload->do_upload("_photo"))
                        {
                            $attachment = array(
                                ...
                                "caption"=>"",
                                "file_url"=>base_url()."assets/uploads/about/".$name,
...
/* Location: ./applications/backend/controllers/aboutme.php */
