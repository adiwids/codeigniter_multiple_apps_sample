...
class Profile extends CI_Controller {
	...
	public function index()
	{
            ...
            else
            {
                ...
                {
                    $this->loadformdata(array("stricttag"=>"__profile__"));
                    $this->getproperty(array(
                            "userid"=>$this->session->userdata('userid')
                        )
                    );
                    $this->load->view("profilepage", $this->property);
                }
            }
	}
	...
	public function savedata()
	{
            ...
            if(isset($_FILES))
            {
                if(!empty($_FILES['_photo']['name']))
                {
                    ...
                    if(!file_exists("./assets/uploads/profile/".$name))
                    {
                        if($this->upload->do_upload("_photo"))
                        {
                            $attachment = array(
                                ...
                                "caption"=>"",
                                "file_url"=>base_url()."assets/uploads/profile/".$name,
            ...
            if($save > 0)
            {
                ...
                $response["module"] = "Profil";
                $response["message"] = "Data berhasil disimpan.";
                $response["backlink"] = base_url()."backend.php/profile/";
            }
            else
            {
...
/* Location: ./applications/backend/controllers/profile.php */
