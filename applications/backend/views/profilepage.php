...
<html>
	<head>
		...
		<script type="text/javascript"> var base_url = '<?php echo base_url(); ?>'; </script>
                ...
                <script type="text/javascript" src="<?php echo base_url(); ?>assets/scripts/backend-profilepage.js"></script>
	</head>
	<body class="normal">
		<div class="container">
			<div class="toolbar">
			...
			<div class="content">
				<div class="sidepanel">
					<ul>
						...
						<li><a href="<?php echo base_url(); ?>backend.php/profile/" class="current">Halaman Profil</a></li>
<!--						<li><a href="<?php echo base_url(); ?>backend.php/post/">Posts</a></li>-->
				...
				<div class="center-content">
					<form action="<?php echo base_url(); ?>backend.php/profile/savedata" enctype="multipart/form-data" class="forms" id="profile-form" method="post">
						<fieldset>
							...
							<div class="fieldcontainer">
								...
								<div style="width: 80%;">
									<label for="_favicon">Foto/Logo:</label>
