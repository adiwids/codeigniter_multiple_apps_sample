...
<html>
	<head>
		...
		<script type="text/javascript"> var base_url = '<?php echo base_url(); ?>'; </script>
                ...
                <script type="text/javascript" src="<?php echo base_url(); ?>assets/scripts/backend-aboutpage.js"></script>
	</head>
	<body class="normal">
		<div class="container">
			<div class="toolbar">
			...
			<div class="content">
				<div class="sidepanel">
					<ul>
						...
						<li><a href="<?php echo base_url(); ?>backend.php/aboutme/" class="current">Halaman Tentang Saya</a></li>
...
<!--						<li><a href="<?php echo base_url(); ?>backend.php/post/">Posts</a></li>-->
				...
				<div class="center-content">
					<form action="<?php echo base_url(); ?>backend.php/aboutme/savedata" enctype="multipart/form-data" class="forms" id="about-form" method="post">
						<fieldset>
