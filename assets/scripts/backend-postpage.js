$(document).ready(
	function()
	{
		$("#btn-submit-publish").click(function(){ submitform(true); });
                $("#btn-submit-save").click(function(){ submitform(false); });
...
{
	var valid = 1;
	if($("#_bio").text().length == 0)
	{
		alert("Isi biografi tidak boleh kosong.");
		$("#_bio").focus();
		valid -= 1;
	}
